            ...
            <div className="w-full max-w-sm mx-auto m-5 bg-white rounded-md shadow-md overflow-hidden">
                ...
                <div className="p-4">
                    ...
                    <div className="flex justify-center mt-4">
                        ...
                        <Link to={`/recipes/${id}`}><button  className="bg-blue-500 outline-none border-none text-white py-2 px-4 rounded-md hover:bg-blue-600 transition-colors duration-300">View Recipes</button></Link>
                    </div>
                </div>
            </div>
</LazyLoad>
