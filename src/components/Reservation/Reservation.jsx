                ...
                <div className="absolute inset-0 text-center ">
                    <div >
                        ...
                        <div className='lg:flex justify-center gap-6 '>
                            ...
                            <input
                                type="date"
                                className="border bg-transparent border-white text-white rounded-md px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full max-w-xs"
                                name={name}
