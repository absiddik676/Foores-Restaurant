...
const Reservation = () => {
    return (
        <div className='my-11'>
            <div className="bg-cover bg-center bg-no-repeat relative " style={{ backgroundImage: `url(${banner}) `, height: '400px' }}>
                ...
                <div className="absolute inset-0 text-center flex justify-center items-center">
                    <div >
                        ...
                        <input  type="date" className="border select cursor-pointer py-2 rounded-md border-white bg-transparent text-white w-full max-w-xs" />
                        <button className='px-4 rounded-lg py-3 shrink-0 text-white font-semibold bg-orange-500'>Book A Table</button>
                        </div>
